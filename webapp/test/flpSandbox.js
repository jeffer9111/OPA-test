		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ux402_opa",
									"targetURL": "#studentcomsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentcomsaptrainingux402opaux402opa-display": {
								"semanticObject": "studentcomsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
